...
** 					 LD3320 有源晶振 12MHZ  不同的晶振请修改LDChip.h 中的
					 定义值（＃define CLK_IN  12）
...
#define LD_MODE_IDLE		0x00	//初始值
#define LD_MODE_ASR_RUN		0x08	//运行ASR识别
#define LD_MODE_MP3		 	0x40	//运行MP3播放
